...
*/ var r = Object.getOwnPropertySymbols,
    ...
    function (e, t, n) {
        ...
        function Ft(e, t) {
            e.blockedOn === t &&
                ((e.blockedOn = null),
                yt || ((yt = !0), i.unstable_scheduleCallback(i.unstable_NormalPriority, Rt)));
        }
        function Dt(e) {
            function t(t) {
                return Ft(t, e);
                            ...
                            e: {
                                ...
                                i.type === ne
                                    ? (((r = Pu(i.props.children, e.mode, u, i.key)).return = e),
                                      (e = r))
                                    : (((u = _u(i.type, i.key, i.props, null, e.mode, u)).ref = ki(
                                          e,
                                          r,
                                          i
                                      )),
                ...
                if (t) {
                    ...
                    if (!Ea(e, t)) {
                        if (!(t = kn(n.nextSibling)) || !Ea(e, t))
                            return (
                                (e.effectTag = (-1025 & e.effectTag) | 2), (ka = !1), void (ba = e)
                            );
                        xa(ba, n);
                    }
    ...
    function (e, t, n) {
        ...
        var r = n(0),
            ...
            i = n(2);
        var a = () => (
            Object(r.useEffect)(() => console.log('medisinsk vilkår microfrontend')),
            l.a.createElement('h3', null, 'Medisinsk vilkår')
        );
        var o = {
            renderAppInSuccessfulState: function (e) {
                Object(i.render)(l.a.createElement(a, null), document.getElementById(e));
            },
            renderAppInLoadingState: function () {
                return l.a.createElement('p', null, 'Laster');
            },
            renderErrorMessage: function () {
                return l.a.createElement('p', null, 'Noe gikk galt :(');
            },
        };
        window.renderMedisinskVilkarApp = async (e) => {
            const { renderAppInSuccessfulState: t } = o;
            t(e);
        };
    },
]);
