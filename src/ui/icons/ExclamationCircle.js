...
export default () => (
    <svg
        ...
        viewBox="0 0 24 24"
        xmlSpace="preserve"
        className="exclamationCircleIcon"
    >
        <path
            className="exclamationCircleIcon__path"
            d="M11.696,0.996l-0.205,0.002c-3.08,0.054-5.979,1.299-8.162,3.506c-2.199,2.223-3.38,5.133-3.327,8.195
