...
import {
    createLivetsSluttfaseVurdering,
} from './apiUtils';
...
import mockedLivetsSluttfaseVurderingsoversikt from './mocked-data/mockedLivetsSluttfaseVurderingsoversikt';
...
app.use('/mock/endre-vurdering', (req, res) => {
    if (req.body.dryRun === true) {
        ...
        mockedLivetsSluttfaseVurderingsoversikt.vurderingselementer =
            mockedLivetsSluttfaseVurderingsoversikt.vurderingselementer.filter((element) => id !== element.id);
        perioder.forEach((periode) => {
            mockedLivetsSluttfaseVurderingsoversikt.vurderingselementer.unshift({
                id,
                periode: periode,
...
app.use('/mock/livets-sluttfase/vurderingsoversikt', (req, res) => {
    ...
    res.send({
        ...mockedLivetsSluttfaseVurderingsoversikt,
        harGyldigSignatur,
        resterendeVurderingsperioder: !harGyldigSignatur
            ? []
            : mockedLivetsSluttfaseVurderingsoversikt.resterendeVurderingsperioder,
    });
});
